...
# from PSets.2017.mixdata import mixdatalist
mixdatamodule = __import__('PSets.2017.mixdata')
mixdatalist = getattr(getattr(getattr(mixdatamodule, '2017'), 'mixdata'), 'mixdatalist')
