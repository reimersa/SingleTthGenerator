...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/B2G-RunIIFall18wmLHEGS-03837-fragment.py nevts:100'),
...
#         filterName = cms.untracked.string('')
#     ),
#     fileName = cms.untracked.string('file:B2G-RunIIFall18wmLHEGS-03837_inLHE.root'),
